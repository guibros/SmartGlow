"""
Ce fichier contient les phrases qui sont analysées par
rapport à la parole reconnue. Il est utilisé par la
classe NLP pour diriger correctement les requêtes
des utilisateurs.
"""
...
hour_models = { "quelle heure est-il",
                "Quelle heure est-il",
                "Donne-moi l'heure",
...
meteo_models = {"quel temps fait-il",
...
meteo_future_models = {"quelle sera la météo demain matin?",
...
medicament_models = {  "Quelles sont mes médicaments",
...
meeting_models = {  "quels sont mes rendez-vous",
...
medecins_models = {"Quel est mon médecin",
...
contact_models = {  "Quels est ma liste de contact",
...
activite_models = {  "quels sont mes activités",
...
models_dict = {"heure": hour_models, "meteo": meteo_models, "meteo futur": meteo_future_models, "medicament": medicament_models,
               "meeting": meeting_models, "medecin": medecins_models, "contact": contact_models, "activite": activite_models}

keyWordDict = {"heure": "heure", "prévision": "meteo futur",  "prévisions": "meteo futur", "météo": "meteo", "température":"meteo",
               "pluie": "meteo", "pleuvoir": "meteo" , "nuageux": "meteo", "soleil": "meteo", "neige": "meteo",
               "médicament": "medicament","médicaments": "medicament", "prescription": "medicament", "prescriptions": "medicament",
               "pilule": "medicament", "pilules": "medicament", "horaire": "meeting", "rendez-vous": "meeting", "meeting": "meeting",
               "médecin": "medecin", "médecins": "medecin", "docteur": "medecin", "docteurs": "medecin",
               "contacts": "contact", "contact": "contact", "contacter": "contact", "contacté": "contact",
               "appeller": "contact", "appellé": "appel", "appelle": "appel", "appel": "appel" , "téléphone": "appel",
               "téléphoner": "appel" , "téléphoné": "appel", "activité": "activite"}